...
export default function FeedPage() {
    ...
    const fetchListings = useCallback(async (isLoadMore = false, currentSearch = '', currentPage = 0) => {
        try {
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-24 bg-white/[0.02] rounded-3xl border border-white/[0.05] backdrop-blur-xl relative overflow-hidden group hover:border-white/10 transition-colors">
                        ...
                        <h3 className="relative z-10 text-2xl font-bold text-white mb-3">No Experiences Found</h3>
                    ...
                    <>
                        ...
                        {hasMore && (
                            <div className="mt-16 text-center">
                                <button
                                    onClick={() => { setLoadingMore(true); fetchListings(true, searchTerm, page); }}
