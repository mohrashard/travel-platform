...
export default function Login() {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#030712] relative overflow-x-hidden selection:bg-indigo-500/30 pt-28 pb-12 px-4">
            ...
            <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                ...
                <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-cyan-500/20 blur-[120px] mix-blend-screen" />
            ...
            <div className="relative z-10 w-full max-w-md p-8 sm:p-10 bg-white/[0.03] backdrop-blur-xl rounded-3xl shadow-[0_0_40px_rgba(99,102,241,0.1)] border border-white/10 my-auto">
